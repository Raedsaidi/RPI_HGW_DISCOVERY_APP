...
const RpiDetailModal = ({ open, onClose, rpiData }) => {
  ...
  const dockerImages     = parseJson(latest?.docker_images)      // ✅ AJOUTÉ
          ...
          {loadingFacts ? (
            ...
            <>
              ...
              <div className="rpi-detail__section">
                ...
                <Row label="Disk Total"   value={latest.disk_total_gb ? `${latest.disk_total_gb} GB` : null} />
                <Row label="Disk Used"    value={latest.disk_used_gb  ? `${latest.disk_used_gb} GB`  : null} />
              ...
              {memPct !== null && (
                <div className="rpi-detail__bar-wrap">
                  <div className="rpi-detail__bar-header">
                    ...
                    <span className={`rpi-detail__bar-pct rpi-detail__bar-pct--${
                          ...
                          {dockerContainers.map((c, i) => (
                            <div key={i} className="rpi-detail__docker-item">
                              ...
                              <div className="rpi-detail__docker-meta">
                                ...
                                {c.created && (
                                  <span className="rpi-detail__docker-created">{c.created}</span>
                                )}
                              </div>
                            </div>
                          ))}
                          ...
                          {dockerImages.map((img, i) => (
                            <div key={i} className="rpi-detail__docker-item">
                              ...
                              <div className="rpi-detail__docker-meta">
                                ...
                                {img.created && (
                                  <span className="rpi-detail__docker-created">{img.created}</span>
                                )}
                              </div>
                            </div>
                          ))}
          ...
          {loadingFacts ? (
            ...
            <div className="rpi-detail__history">
              {facts.map((fact) => {
                ...
                const images     = parseJson(fact.docker_images)  // ✅ AJOUTÉ
